...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=grikomsn.opencode-copilot-chat"><img src="https://img.shields.io/visual-studio-marketplace/v/grikomsn.opencode-copilot-chat?style=flat-square&logo=visualstudiocode&label=Marketplace" alt="Visual Studio Marketplace version"></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=grikomsn.opencode-copilot-chat"><img src="https://img.shields.io/visual-studio-marketplace/i/grikomsn.opencode-copilot-chat?style=flat-square&label=Installs" alt="Visual Studio Marketplace installs"></a>
...
1. Install [OpenCode for Copilot Chat](https://marketplace.visualstudio.com/items?itemName=grikomsn.opencode-copilot-chat). You need VS Code 1.125 or newer and GitHub Copilot Chat.
